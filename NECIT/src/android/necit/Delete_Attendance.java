...
public class Delete_Attendance extends Activity{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		delete=(Button)findViewById(R.id.attendance_delete);
		
		spin=(Spinner)findViewById(R.id.delete_attendance_spinner);
    ...
    Database db = new Database(Delete_Attendance.this); 
		
		
			
			db.open();
			
			Cursor cn=db.spinner_attendance();
			...
			delete.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					db.open();
				       ...
				       if(db.del_attendence(delete_spinner)){
